...
/**
 * SingleBoardComputer Model
 * ==========
 */

var SingleBoardComputer = new keystone.List('SingleBoardComputer', {
	path: 'sbcs',
	track: {
		createdBy: true,
		updatedBy: true,
...
SingleBoardComputer.add({
  manufacturer: { type: Types.Relationship, ref: 'SingleBoardComputerManufacturer', many: false, initial: true, createInline: true },
  title: { type: Types.Text, required: true, index: true, initial: true },
  type: { type: Types.Text },
  releaseDate: { type: Types.Date },
  introPrice: { type: Types.Money },
	heroImage: { type: Types.CloudinaryImage },
	operatingSystem: { type: Types.Relationship, ref:'OperatingSystem', label: 'Operating System', createInline: true, initial: true, index: true, many: true },
  ...
  programmingLanguageSupport: { type: Types.Relationship, ref:'ProgrammingLanguage', label: 'Programming Languages Supported', createInline: true, many: true, required: true, initial: true, index: true },
	storage: { type: Types.Text },
	displayOutput: { type: Types.Text },
	audioPort: { type: Types.Text },
	audioPlayback: { type: Types.Text },
	GPIO: { type: Types.Text },
	videoInput: { type: Types.Text },
	videoOutput: { type: Types.Text },
	powerOutput: { type: Types.Text },
	CPUCount: {
    type: Types.Number,
		label: 'CPU Count',
		initial: true
...
SingleBoardComputer.schema.virtual('description.full').get(function () {
	return this.description.extended || this.description.brief;
});

SingleBoardComputer.defaultColumns = 'title, state|20%, createdBy|20%, createdAt|20%';
SingleBoardComputer.register();
